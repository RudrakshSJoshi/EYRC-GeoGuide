...
def classify_event(image):
    ...
    model_path = "D:\\HP\\users\\OneDrive\\Desktop\\eyantra\\Task_1A\\task_2b_evaluator\\hello.h5"
    ...
    class_names = ["combat", 'fire', "destroyedbuilding", "humanitarianaid", "militaryvehicles"]
